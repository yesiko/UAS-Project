...
public class QuizGame {
    ...
    private static void takeQuiz(Scanner scanner) {
        ...
        takeQuizRecursive(scanner, quiz, 0, 0);
    }

    private static void takeQuizRecursive(Scanner scanner, Quiz quiz, int questionIndex, int score) {
        if (questionIndex >= quiz.getNumQuestions()) {
        ...
        takeQuizRecursive(scanner, quiz, questionIndex + 1, score);
    }
